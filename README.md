...
|React - [Bootstrap](https://getbootstrap.com/docs/5.3/getting-started/download/) |npm i bootstrap or yarn add bootstrap:[^1] [^1]: + App.js de bu sekilde import edilmeli import "bootstrap/dist/css/bootstrap.css";| |      
